...
export function getSystemPrompt(intentType, maxLines) {
    switch (intentType) {
        case 'greeting':
            return `Asistente de cotizaciones textiles. Español. Máx 1 línea. Responde con un saludo cordial breve y ofrece ayuda. No analices datos.`;
