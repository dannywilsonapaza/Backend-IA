...
export const config = {
    ...
    // Proveedor de IA
    provider: (process.env.PROVIDER || '').toLowerCase() ||
    ...
    backendPrincipalUrl: process.env.BACKEND_PRINCIPAL_URL || 'http://128.1.17.63:3100',
    backendPrincipalTimeout: Number(process.env.BACKEND_PRINCIPAL_TIMEOUT || 10000),
...
export const isOpenAiProvider = () => config.provider === 'openai' && isOpenAiEnabled();
