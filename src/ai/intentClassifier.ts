...
export function detectIntent(msg: string): IntentType {
...
export function classifyMessage(mensaje: string): {
  intent: IntentType;
  classification: 'greeting' | 'data-only' | 'detalle' | 'default';
  isGreetingMode: boolean;
  wantsDetail: boolean;
  needsSimilares: boolean;
} {
